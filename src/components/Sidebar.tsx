...
export const Sidebar = (props: ModalTypes) =>{
  ...
  return(
    <aside data-aos={"fade-right"} className={`absolute md:static top-[17.5rem] 345:top-[19.5rem] 425:top-[21rem] z-10 w-full md:w-[400px] ${!props.modal ? 'hidden' : 'inline'} md:w-[348px] bg-gray-700 p-2 md:p-6 border-l border-gray-600`}>
